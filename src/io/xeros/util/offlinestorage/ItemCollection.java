package io.xeros.util.offlinestorage;
...
public class ItemCollection {
    ...
    public static final JsonIO IO = new JsonIO("C:/Users/"+ Configuration.SAVES+"/Dropbox/etc/cfg/collection_box/") {
