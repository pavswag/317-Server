...
public final class ItemStats {
    ...
    public static Int2ObjectMap<ItemStats> itemStatsMap;

    public static void load() {
        try (FileReader fr = new FileReader("C:/Users/"+ Configuration.SAVES+"/Dropbox/etc/cfg/item/item_stats.json")) {
    ...
    public static ItemStats forId(int itemId) {
        return itemStatsMap.getOrDefault(itemId, DEFAULT);
    }
