...
public class NpcStats {
    ...
    public static Int2ObjectMap<NpcStats> npcStatsMap;
    private static int missing;

    public static void load() {
        try (FileReader fr = new FileReader("C:/Users/"+ Configuration.SAVES+"/Dropbox/etc/cfg/npc/npc_stats.json")) {
            npcStatsMap = new Gson().fromJson(fr, new TypeToken<Int2ObjectOpenHashMap<NpcStats>>() {
            }.getType());
