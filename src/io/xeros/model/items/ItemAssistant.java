...
public class ItemAssistant {
	...
	public void calculateBonuses() { //here
		...
		player.getPA().sendString(65035, CharacterInformationPanel.formatString(DropManager.getDropRateModifier(player)));
	...
	public void deleteEquipment() {
		...
		if ( (Arrays.stream(WeaponDataConstants.THROWN).anyMatch(id -> id == thrownweapons)
				|| player.usingOtherRangeWeapons) && !player.getItems().isWearingItem(Items.TOXIC_BLOWPIPE)) {
			if (player.getItems().isWearingItem(10499, Player.playerCape)
					|| player.getItems().isWearingItem(22109, Player.playerCape)
					|| player.getItems().isWearingItem(28955, Player.playerCape)
					|| player.getItems().isWearingItem(28902, Player.playerCape)
					|| player.getItems().isWearingItem(33037, Player.playerCape)
					|| SkillcapePerks.RANGING.isWearing(player)
