...
public class DoorDefinition {
	...
	public static void load() throws IOException {
		List<DoorDefinition> list = new Gson().fromJson(FileUtils.readFileToString(new File("C:/Users/"+ Configuration.SAVES+"/Dropbox/etc/cfg/obj/door_definitions.json")), new TypeToken<List<DoorDefinition>>() {
		}.getType());
