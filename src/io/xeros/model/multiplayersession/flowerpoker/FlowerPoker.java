...
/*        long milliseconds = (long) player.playTime * 600;
        ...
        /*if ((player.foundryPoints - 2_000_000) < 0) {
            player.sendMessage("You don't have enough Upgrade Points to gamble!");
            requested.sendMessage("Your opponent doesn't have enough Upgrade Points to gamble!");
            return;
        }

        if ((requested.foundryPoints - 2_000_000) < 0) {
            requested.sendMessage("You don't have enough Upgrade Points to gamble!");
            player.sendMessage("Your opponent doesn't have enough Upgrade Points to gamble!");
            return;
        }*/
...
/*
        player.sendMessage("@red@Gambling costs 2Million non-refundable Upgrade Points points!");
        requested.sendMessage("@red@Gambling costs 2Million non-refundable Upgrade Points points!");
*/
