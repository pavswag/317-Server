...
public class Boundary {
	...
	public static final Boundary DZ3 = new Boundary(2046, 2688, 2175, 2752);
	...
	public static final Boundary ONYX_ZONE_NEW = new Boundary(1312, 2880, 1485, 3007);
	public static final Boundary DIAMOND_ZONE = new Boundary(2308, 9796, 2364, 9915);
	public static final Boundary ZENYTE_ZONE = new Boundary(2048, 2688, 2175, 2751);
	public static final Boundary TOMBS_OF_AMASCUT_LOBBY_ENTRANCE = new Boundary(3336, 9095, 3381, 9133);

	public static final Boundary TOMBS_OF_AMASCUT_TUMEKENS_WARDEN = new Boundary(3788, 5134, 3827, 5172);
	public static final Boundary BABA_BOSS_ROOM_BOUNDARY = new Boundary(3788, 5397, 3982, 5419);
	public static final Boundary CRONDIS_BOSS_ROOM_BOUNDARY = new Boundary(3920, 5401, 3943, 5418);
...
//3082 3921
	...
	public static final Boundary ENCHANTED_VALLEY = new Boundary(3008, 4480, 3071, 4543);
	...
	public static final Boundary LEV_ATTACK_BOUNDARY = new Boundary(2072,6363,2091,6383);
