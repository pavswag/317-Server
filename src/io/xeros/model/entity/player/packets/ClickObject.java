    ...
    private static void finishObjectClick(Player c, int option, WorldObject worldObject) {
        ...
        switch (option) {
            case 1:
                ...
                if (io.xeros.content.dwarfleaguecannon.Cannon.clickObject(c, c.objectId, new Position(c.objectX, c.objectY, c.getHeight()), 1)) {
                    return;
                }
				...
				switch (c.objectId) {
                    ...
                    case 30943: {
                        ...
                        c.getUpgradeInterface().showUpgrade(c.getUpgradeInterface().upgradeMaterialsArrayList.get(0));
                        return;
                    }
...
/*                    case 29735:// Basic training
            ...
            case 2:
                ...
                if (io.xeros.content.dwarfleaguecannon.Cannon.clickObject(c, c.objectId, new Position(c.objectX, c.objectY, c.getHeight()), 2)) {
                    return;
                }
                if (OurianaBanker.clickObject(c, c.objectId, option)) {
                    return;
            ...
            case 3:
                ...
                if (io.xeros.content.dwarfleaguecannon.Cannon.clickObject(c, c.objectId, new Position(c.objectX, c.objectY, c.getHeight()), 3)) {
                    return;
                }
