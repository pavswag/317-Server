...
//				c.getDH().sendDialogues(12000, -1);
		...
		if (BryophytaStaff.handleItemOption(c, itemId, 2)) return;
			...
			case 12904:
				...
				case 13660:
					if(c.wildLevel > Configuration.NO_TELEPORT_WILD_LEVEL && c.petSummonId != 10533  && !c.getLoginName().equalsIgnoreCase("Mercy")) {
			...
			case 9763:
				...
				case 19707:
					...
					if (c.wildLevel > 30 && c.petSummonId != 10533 && !(c.getRights().isOrInherits(Right.STAFF_MANAGER))) {
