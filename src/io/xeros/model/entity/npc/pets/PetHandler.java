...
//        ANTI_SANTA_JR(9959, 1048, "Anti-Santa", 500,"first"),
        ...
        SMOL_HEREDIT (28960, 12767, "Sol Heredit", 30000, "second"),
        ...
        KEPHRITI (27384, 11842, "", -1, "second"),
        AKKHITO (27382, 11840, "", -1, "second"),
        BABI (27383, 11841, "", -1, "second"),
...
;
    ...
    public static ArrayList<GameItem> getPetIds(boolean parent) {
        ...
        drops.removeIf(drop -> drop.getId() == 33159 || drop.getId() == 30122
                ...
                || drop.getId() == 27385 || drop.getId() == 18);
    ...
    public static void roll(Player player, Pets p) {
        ...
        if (player.getPerkSytem().gameItems.stream().anyMatch(item -> item.getId() == 33116) && (Misc.random(0, 100) > ((player.getItems().isWearingItem(10557)||player.getItems().isWearingItem(22954)) ? 80 : 95)))  {
            random = 1;
        }
