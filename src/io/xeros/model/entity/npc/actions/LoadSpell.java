...
import io.xeros.content.bosses.fluffie.Fluffie;
import io.xeros.content.bosses.hespori.Hespori;
import io.xeros.content.bosses.vardorvis.Vardorvis;
import io.xeros.content.bosses.whisperer.TheWhisperer;
...
import static io.xeros.content.bosses.DonorBoss3.burnGFX;
    ...
    public static void loadSpell(Player player, NPC npc) {
        ...
        switch (npc.getNpcId()) {
            ...
            case 1802:
                ...
                break;
            case 12821:
                int corRandom = Misc.random(25);
                if (corRandom >= 12) {
                    npc.setAttackType(CombatType.MAGE);
                    npc.hitDelayTimer = 3;
                    npc.projectileId = Misc.random(1) == 0 ? 361 : 362;
                    npc.endGfx = -1;
                }
                if (corRandom >= 3 && corRandom <= 11) {
                    npc.setAttackType(CombatType.MELEE);
                    npc.projectileId = -1;
                    npc.hitDelayTimer = 2;
                    npc.endGfx = -1;
                ...
                if (corRandom <= 2) {
                    npc.setAttackType(CombatType.MELEE);
                    npc.hitDelayTimer = 3;
                    handler().groundSpell(npc, player, 362, 361, "corp", 4);
                }
                break;
            ...
            case Skotizo.SKOTIZO_ID:
                int randomStyle;
                if (player.getSkotizo() != null && player.getSkotizo().firstHit) {
                    randomStyle = 1;
