package io.xeros.model.entity.thrall;
...
public enum ThrallSystem {
    ...
    GREATER_GHOST(ThrallType.GHOST, 6, 30,  10880,5545, 8, CombatType.MELEE),
...
/*        if (!unlockedThrall(player, thrall)) {
        ...
        NPCSpawning.spawnThrall(player, thrall.npcId, player.absX + offsetX, player.absY + offsetY,
                player.getHeight(), 8, true, false, true);
    }

    public static void handleThrallAutoAttack(NPC thrall) {
        System.out.println("sending attacks");
        thrall.setNpcAutoAttacks(Lists.newArrayList(
                new NPCAutoAttackBuilder()
                        ...
                        .setAccuracyBonus(npcCombatAttack -> 600.0)
                        .setAttackDelay(3)
                        .setMaxHit(25)
                        .createNPCAutoAttack()
        ));
