package io.xeros.content.WeaponGames;
    ...
    public static void randomPowerup(Player player) {
        ...
        switch (rng) {
            case 1:
                ...
                player.sendMessage("[<col=ff7000>POWER UP</col>]: You've been healed and got an overload buff!");
                break;
            case 2:
                player.healEverything();
                player.getPotions().drinkStatPotion(-1, 27, 1, true);
                player.sendMessage("[<col=ff7000>POWER UP</col>]: You've been healed and got a defence buff!");
                break;
            case 3:
                player.healEverything();
                player.getPotions().drinkStatPotion(-1, 27, 0, true);
                player.sendMessage("[<col=ff7000>POWER UP</col>]: You've been healed and got an attack buff!");
                break;
            case 4:
                player.healEverything();
                player.getPotions().drinkStatPotion(-1, 27, 2, true);
                player.sendMessage("[<col=ff7000>POWER UP</col>]: You've been healed and got a strength buff!");
                break;
            case 5:
                player.healEverything();
                player.getPotions().doAllDivine();
                player.sendMessage("[<col=ff7000>POWER UP</col>]: You've been healed and got a combo buff!");
                break;
            case 6:
                player.healEverything();
