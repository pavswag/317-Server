...
public class ReferralCode {
    ...
    public static void load() throws IOException {
        ...
        List<ReferralCode> list = new ObjectMapper(new YAMLFactory()).readValue(new File("C:/Users/"+ Configuration.SAVES+"/Dropbox/etc/cfg/referral_codes.yaml"), new TypeReference<List<ReferralCode>>() {});
        list.forEach(it -> {
