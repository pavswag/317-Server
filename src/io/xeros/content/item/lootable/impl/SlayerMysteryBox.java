	...
	static {
		items.put(LootRarity.COMMON,
				Arrays.asList(
						...
						new GameItem(8901),  //black mask
						new GameItem(20718, 50),  //Burnt Page
		...
		items.put(LootRarity.RARE,
				Arrays.asList(
						new GameItem(19835, 12),  //master clue
						new GameItem(23951, 5),   //crystalline key
						new GameItem(FragmentOfSeren.KEY, 5),  //serens key
						new GameItem(TheUnbearable.KEY, 5),    //sotetsegs key
