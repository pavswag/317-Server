...
import io.xeros.content.items.LootItem;
import io.xeros.content.items.LootTable;
...
import static io.xeros.content.minigames.raids.RaidConstants.checkInstances;
...
//
            ...
            case OLM:
                ...
                getPlayers().forEach(player -> {
                    ...
                    for (int i = 0; i < 3; i++) { // up to 3 uniques
                        ...
                        double chance = (double) pointsToUse / 4000 / 100.0; // 1% chance per 4200 points - OSRS = 8675
    ...
    private static LootTable uniqueTable = new LootTable()
            .addTable(1,
                    ...
                    new LootItem(28696, 1, 2),  // SS PRAYER
