...
public class ArboRoomFour extends ArboRaidRoom {
    @Override
    public void spawn(InstancedArea instancedArea) {
        for (int i = 0; i < 2; i++) {
            NPC npc = new NPC(Npcs.FIRE_GIANT, new Position(1687, 4251 + i * 2, instancedArea.getHeight()));
    ...
    public Boundary getBoundary() {
        return ArboRaidConstants.ROOM_FOUR;
    }
