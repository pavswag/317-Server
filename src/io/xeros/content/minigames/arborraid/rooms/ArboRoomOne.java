...
public class ArboRoomOne extends ArboRaidRoom {
    @Override
    public void spawn(InstancedArea instancedArea) {
        for (int i = 0; i < 5; i++) {
            NPC npc = new NPC(Npcs.GOBLIN, new Position(1685 + i, 4268, instancedArea.getHeight()));
    ...
    public Boundary getBoundary() {
        return ArboRaidConstants.ROOM_ONE;
    }
