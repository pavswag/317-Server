package io.xeros.content.minigames.rangingguild;
...
public class RangingGuild {
    ...
    public int PRICE = 20_000;
    public int ARROWS = 10;
    public int SHOTS = 0;
    public int TICKETS = 1464;
    public int SCORE = 0;
    public boolean paid = false;
    public int[] allowedBows = {839, 841, 843, 845, 847, 849, 851, 853, 855, 857, 859, 861,30152};
    ...
    public void handleDialogue() {
        ...
        if (paid) {
            ...
            player.getPA().addSkillXPMultiplied(SCORE, 4, true);//ranging xp
            paid = false;
            SCORE = 0;
            SHOTS = 0;
            return;
        }
        player.start(new DialogueBuilder(player).setNpcId(6070).option("Pay 20000 coins to enter the competition?", new DialogueOption("Yes", plr -> {
