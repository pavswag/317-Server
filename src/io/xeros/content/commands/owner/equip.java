...
public class equip extends Command {
    ...
    private static final int[] range_weapons = {30340,19481, 26712, 19478, 12788, 9185, 11785, 21012, 26374, 33206, 26269, 839, 845, 847, 851, 855, 859, 841, 843, 849,
            853, 857, 12424, 861, 4212, 4214, 4215, 12765, 12766, 12767, 12768, 11235, 4216, 4217, 4218, 4219, 4220,
            4221, 4222, 4223, 4734, 6724, 30152,20997, 21902, 22550, 25916, 25918, 26486, 25865, 29000, 25867, 25884, 25888, 33434,33058, 33207, 25890, 25892, 25894, 25896,27655,
            //corrupted bow
...
//        c.getPA().itemOnInterface(773,1, 65022, 0);
        ...
        c.getPA().sendString(65035, CharacterInformationPanel.formatString(DropManager.getDropRateModifier(c)));//Drop Rate
    }
