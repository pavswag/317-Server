...
public class Killallaoe extends Command {
    ...
    public void execute(Player player, String commandName, String input) {
        ...
        int killed = AoeNpcSpawner.killAll(instOpt.get());
        player.sendMessage("AOE instance kill request queued for " + killed + " NPCs.");
    }
    ...
    public Optional<String> getDescription() {
        return Optional.of("kills all aoe instance npcs for respawn testing");
    }
}
