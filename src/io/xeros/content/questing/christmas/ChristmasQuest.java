package io.xeros.content.questing.christmas;
...
public class ChristmasQuest extends Quest {
    ...
    public List<String> getJournalText(int stage) {
        ...
        switch (stage) {
            ...
            if (Christmas) {
                    ...
                    lines.add("");
                    lines.add("Rewards:");
                lines.add("1/3 chance of either CandyCane Scythe, Twisted bow, and whip");
                    lines.add("2 Christmas Boxes");
                    lines.add("10m coins");
                    lines.add("4m upgrade points");
            ...
            case 15:
                ...
                lines.add("as the present's where stolen by anti-santa and his evil Yeti.");
                break;
            case 16:
                lines.add("I should back to santa to tell him,");
                lines.add("how I managed to get the present's.");
            ...
            case 17:
                ...
                lines.add("Exclusive candycane weapon");
                lines.add("2 Christmas Boxes");
                lines.add("10m coins");
                lines.add("4m upgrade points");
                lines.add("200 seasonal points");
    ...
    public List<String> getCompletedRewardsList() {
        return Lists.newArrayList("2 Christmas Boxes", "Exclusive Candy Cane Wep",
                "4m upgrade pts", "10M Coins");
    }

    @Override
    public void giveQuestCompletionRewards() {
        player.setSeasonalPoints(player.getSeasonalPoints() + 200);
        player.foundryPoints += 4_000_000;
        player.getItems().addItemUnderAnyCircumstance(995, 10_000_000);
        player.getItems().addItemUnderAnyCircumstance(12161, 2);
        player.getItems().addItemUnderAnyCircumstance(10501, 10000);
        player.sendMessage("You can charge your new candy cane weapon with Snowballs!");
        int pts;
        pts = Misc.random(3);
        if (pts == 2) {
            player.getItems().addItemUnderAnyCircumstance(33162, 1);
        }
        if (pts == 3) {
            player.getItems().addItemUnderAnyCircumstance(33160, 1);
        }
        if (pts == 0) {
            player.getItems().addItemUnderAnyCircumstance(33161, 1);
        }
        if (pts == 1) {
            player.getItems().addItemUnderAnyCircumstance(33160, 1);
        }
                ...
                switch (getStage()) {
                    case 0:
                        player.start(new DialogueBuilder(player).statement("wow! are you the real santa?!?")
                                ...
                                .statement("I was out delivering presents to the lovely people of Turmoil,",
                                ...
                                .statement("I managed to gain control of the sleigh but,",
                                        ...
                                        "around Turmoil, I need to find the presents","so Anti-Santa doesn't ruin Christmas.")
                    ...
                    case 2:
                        player.start(new DialogueBuilder(player).statement("I've found the presents from mining Santa!")
                                .statement( "That's great news! I just heard from one of my elfs"," while he was flying over in the sleigh,"
                                        ,"he noticed presents over by the magic trees the skilling area.")
                    ...
                    case 14:
                        player.start(new DialogueBuilder(player).statement("I got the last present Santa, we saved Christmas!")
                                ...
                                .statement("Speak with jack and he will take you","to the place where the present's are being hidden",
                                        ...
                                        "you get yourself something to kill a yeti.")
                    ...
                    case 15:
                        player.start(new DialogueBuilder(player).statement("Santa, can you tell me what I had to do again.")
                                .statement("You need to go speak to jack, and he'll take you to the Evil Yeti.")
                                .exit(player1 -> {
                                    player1.getPA().closeAllWindows();
                                }));
                        break;
                    ...
                    case 16:
                        player.start(new DialogueBuilder(player).statement("I got all the presents back Santa, we saved Christmas!",
                                ...
                                .statement("Thank you santa!").exit(player1 -> {
                                    ...
                                    PlayerHandler.executeGlobalMessage("<img=28>[@red@C@gre@H@red@R@gre@I@red@S@gre@T@red@M@gre@A@red@S@bla@]<img=28> @pur@"+ player1.getDisplayName() + " has just completed the Christmas Quest!");
                                })
                        );
                        break;
                }
                ...
                switch (getStage()) {
                    case 9:
                        player.start(new DialogueBuilder(player).statement("Hi Pong, it's a pleasure to meet you.")
                                ...
                                .npc(837, "Your saving christmas, you're a hero to all us on Turmoil!")
    ...
    public void handleNpcKilled(NPC npc) {
        ...
        //kill evil snowman
        if (getStage() == 15 && npc.getNpcId() == 2847) {
            player.setPresentCounter(player.getPresentCounter() + 100);
            player.sendMessage("You found all the missing present's from last year!");
