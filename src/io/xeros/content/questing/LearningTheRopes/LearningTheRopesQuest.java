    ...
    public List<String> getJournalText(int stage) {
        ...
        switch (stage) {
            ...
            case 16:
                ...
                break;
            case 17:
                lines.add("I learnt how to begin in Turmoil");
            ...
            if (option == 1) {
                if (getStage() == 0) {
                                        ...
                                        player.start(getXerosGuide()
                                                ...
                                                .option(new DialogueOption("Sure, I can start now!", e -> {
                                                            ...
                                                            e.start(getXerosGuide()
                                                                    ...
                                                                    .npc("The information these display", "will help you during your time in Turmoil.")
                    ...
                    player.start(getXerosGuide()
                            ...
                            .npc(DialogueExpression.CALM_TALK, "They are worth a lot of Upgrade Points", "I will reward you if you get the certificates.")
                    ...
                    player.start(getXerosGuide()
                            ...
                            .npc(DialogueExpression.CALM, "For the Upgrade Points!", "Items can be destroyed for points.")
