...
public class ModeSelection {
    ...
    public enum KitData {
        NORMAL(Right.PLAYER, new String[]{
                "Play Turmoil as a casual player.",
                "This game mode has no restrictions at all.",
                "1x, 5x, 10x, 25x experience rates available."
        }, new GameItem[]{new GameItem(29028, 1), new GameItem(29022, 1), new GameItem(29025, 1), new GameItem(28055, 1), new GameItem(7461, 1), new GameItem(28534, 1), new GameItem(6568, 1), new GameItem(11964, 1), new GameItem(33417, 1)},
