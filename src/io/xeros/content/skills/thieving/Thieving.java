 ...
 */
	...
	public enum Stall {
		Cake(new GameItem(1893), 1, 16, 20, 2500),
		Silk(new GameItem(950), 25, 30, 10, 2500),
		Tea(new GameItem(712), 25, 30, 10, 2500),
		...
		Gems(new GameItem(19473), 75, 100, 10, 2500),
		Scimitar(new GameItem(1993), 85, 120, 10, 2500),
		Magic(new GameItem(1613), 90, 120, 10, 2500),
		Gold(new GameItem(4692), 95, 220, 10, 2500),
		LZ_GOLD(new GameItem(19473), 99, 300, 10, 2500);
