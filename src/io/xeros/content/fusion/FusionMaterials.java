...
import static io.xeros.content.fusion.FusionSystem.*;
import static io.xeros.content.fusion.FusionTypes.*;
...
public enum FusionMaterials {
    ...
    public static final FusionMaterials[] VALUES = FusionMaterials.values();
