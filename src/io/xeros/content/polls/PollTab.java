...
public class PollTab {
    ...
    public static void init() {
        try {
            Path path = Paths.get("C:/Users/"+ Configuration.SAVES+"/Dropbox/etc/cfg/poll/polls_backup.json");
    ...
    public static void reloadPoll() {
        try {
            Path path = Paths.get("C:/Users/"+Configuration.SAVES+"/Dropbox/etc/cfg/poll/poll.json");
            File file = path.toFile();
...
//        }
    ...
    public static void savePolls() {
        ...
        BufferedWriter bw;
        try {
            bw = new BufferedWriter(new FileWriter(new File("C:/Users/"+Configuration.SAVES+"/Dropbox/etc/cfg/poll/polls_backup.json")));
            bw.write(prettyJson);
            bw.flush();
            bw.close();
        } catch (Exception e) {
