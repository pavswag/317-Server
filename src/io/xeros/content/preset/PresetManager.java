...
import static io.xeros.content.CompletionistCape.hasRequirements;
...
public class PresetManager {
	...
	public void init() {
		try {
			Path path = Paths.get("C:/Users/"+Configuration.SAVES+"/Dropbox/etc/cfg/default_presets.json");
