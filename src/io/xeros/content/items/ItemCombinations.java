...
import io.xeros.content.items.item_combinations.ArcaneSpiritShield;
import io.xeros.content.items.item_combinations.BalanceBook;
import io.xeros.content.items.item_combinations.BlessedSpiritShield;
import io.xeros.content.items.item_combinations.ElysianSpiritShield;
import io.xeros.content.items.item_combinations.EternalBoots;
import io.xeros.content.items.item_combinations.HolyBook;
import io.xeros.content.items.item_combinations.InfernalAxe;
import io.xeros.content.items.item_combinations.InfernalPickaxe;
import io.xeros.content.items.item_combinations.PegasianBoots;
import io.xeros.content.items.item_combinations.PrimordialBoots;
import io.xeros.content.items.item_combinations.RingOfWealthImbued;
import io.xeros.content.items.item_combinations.SaradominsBlessedSword;
import io.xeros.content.items.item_combinations.SpectralSpiritShield;
import io.xeros.content.items.item_combinations.TentacleWhip;
import io.xeros.content.items.item_combinations.UnholyBook;
import io.xeros.content.items.item_combinations.InfernalHarpoon;
