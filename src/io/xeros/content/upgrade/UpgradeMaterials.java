...
public enum UpgradeMaterials {
    ...
    SHADOW(WEAPON, 75, new GameItem(12774, 1), new GameItem(30154, 1), 5_000_000, 35, 100,true),

    ABYSSAL_TENTACLE(WEAPON, 80, new GameItem(12006, 1), new GameItem(26484, 1), 3_000_000, 35, 250,true),

    ARMADYL_GODSWORD(WEAPON, 85, new GameItem(11802, 1), new GameItem(20368, 1), 10_00_000, 50, 250,true),
    ...
    BANDOS_GODSWORD(WEAPON, 85, new GameItem(11804, 1), new GameItem(20370, 1), 10_00_000, 50, 250,true),

    Dragon_CLAWS(WEAPON, 60, new GameItem(20784, 1), new GameItem(26708, 1), 7_500_000, 40, 100,true),

    DRAGON_WARHAMMER(WEAPON, 60, new GameItem(13576, 1), new GameItem(26710, 1), 10_00_000, 40, 100,true),
    ...
    Magma_Twisted_bow(WEAPON, 85, new GameItem(33058, 1), new GameItem(30152, 1), 1250_000_000, 45, 10000,true),
    ...
    ARMADYL_BODY_F(ARMOUR, 99, new GameItem(27229, 1), new GameItem(27238, 1), 100_00_000, 20, 15000,true),

    ARMADYL_LEGS_F(ARMOUR, 99, new GameItem(27232, 1), new GameItem(27241, 1), 100_00_000, 20, 15000,true),

    ANCIENT_MASK(ARMOUR, 99, new GameItem(26225, 1), new GameItem(33141, 1), 100_00_000, 20, 15000,true),

    ANCIENT_BODY(ARMOUR, 99, new GameItem(26221, 1), new GameItem(33142, 1), 100_00_000, 20, 15000,true),

    ANCIENT_BOTTOMS(ARMOUR, 99, new GameItem(26223, 1), new GameItem(33143, 1), 100_00_000, 20, 15000,true),
