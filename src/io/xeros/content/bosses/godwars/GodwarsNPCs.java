...
public class GodwarsNPCs {
	...
	public static void load() throws IOException {
		List<GodwarsNPCs> list = new Gson().fromJson(FileUtils.readFileToString(new File("C:/Users/"+ Configuration.SAVES+"/Dropbox/etc/cfg/npc/god_npcs.json")), new TypeToken<List<GodwarsNPCs>>() {
		}.getType());
