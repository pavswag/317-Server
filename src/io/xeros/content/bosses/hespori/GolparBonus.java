...
public class GolparBonus implements HesporiBonus {
    ...
    public void activate(Player player) {
        ...
        Discord.writeBugMessage("The Consecration has sprouted and is granting 1 hour of 2x bonus loot including: Crystal keys, Coin bags, Resource boxes and Clues! @News-PvM");
