...
public class CombatItems {
	...
	public boolean usingBlowPipe() {
		return c.playerEquipment[Player.playerWeapon] == Items.TOXIC_BLOWPIPE || c.playerEquipment[Player.playerWeapon] == 28688|| c.playerEquipment[Player.playerWeapon] == 30270;
	}
