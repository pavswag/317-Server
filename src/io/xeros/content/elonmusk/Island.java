package io.xeros.content.elonmusk;
...
/**
 * @author Turmoil
 * @project Turmoil-server
 * @social Discord: Turmoil
 * Website: www.Turmoil.net
 * @since 27/11/2023
 */
public class Island extends InstancedArea {
    ...
    public void spawnItems(Player player, int height) {
        if (player.getPerkSytem().gameItems.stream().anyMatch(item -> item.getId() == 33110) || player.playerEquipment[Player.playerAmulet] == 33407 || player.playerEquipment[Player.playerAmulet] == 24725 || player.playerEquipment[Player.playerAmulet] == 26914) {
            return;
        }
